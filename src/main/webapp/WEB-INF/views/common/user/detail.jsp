...
<%--                        <label class="layout-col layout-col-head"><strong>*</strong> 회원</label>--%>
<%--                        <input id="code" class="width210" type="text" maxlength="25"/>--%>
<%--                    </div>--%>
<%--                    <div class="layout-row">--%>
<%--                        <label class="layout-col layout-col-head"><strong>*</strong> 회원명</label>--%>
<%--                        <input id="codeName" class="width210" type="text" maxlength="25"/>--%>
<%--                    </div>--%>
<%--                    <c:if test="${upperCode ne ''}">--%>
<%--                        <div class="layout-row">--%>
<%--                            <label class="layout-col layout-col-head"><strong>*</strong>부모 회원</label>--%>
...
<%--                    <div class="layout-row">--%>
<%--                        <c:if test="${mode eq 'detail'}">--%>
<%--                            <label class="layout-col layout-col-head">회원</label>--%>
<%--                            <label class="layout-col width25p" id="codeDt"></label>--%>
<%--                            <label class="layout-col layout-col-head">회원명</label>--%>
...
<%--                            <label class="layout-col layout-col-head">부모회원</label>--%>
